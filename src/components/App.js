...
const App = () => {
  ...
  if (tours.length === 0) {
    return (
      <main id="main" className="text-center mt-20">
        <h2 className="text-2xl font-bold mb-4">No more tours</h2>
    ...
    return(
      <main id="main" className="container mx-auto p-4">
        <h1 className="title text-4xl font-bold text-center mb-6">Our Tours</h1>
